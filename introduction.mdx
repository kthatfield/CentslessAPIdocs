...
Penny production ceased in November 2025. Eight states have enacted cash rounding legislation, each with a different methodology and enforcement model. No federal standard exists. Every cash transaction in America now operates without a compliance framework.
...
All eight states require sales tax to be calculated on the pre-rounded amount.
